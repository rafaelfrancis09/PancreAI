(function () {
  window.PancreAIArchitecture = {
    ...
    currentRecognitionProvider: "RealMealRecognitionProvider + Gemini Flash",
    ...
    modules: [
      ...
      { name: "Análise visual", file: "src/services/recognition/realMealRecognitionProvider.js", status: "funcional", label: "Foto enviada ao backend e analisada pelo Gemini Flash" },
    ...
    currentFlow: ["Foto real", "Backend seguro", "Gemini Flash", "Revisão obrigatória", "Banco nutricional local", "Cálculo determinístico", "Validação", "Histórico local"]
  };
})();
