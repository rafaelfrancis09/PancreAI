(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      "analysis.realPhotoNotice": "A foto será analisada no próprio aparelho e deve ser revisada antes do cálculo.",
    ...
    en: {
      ...
      "analysis.realPhotoNotice": "The photo will be analyzed on this device and must be reviewed before calculation.",
    ...
    es: {
      ...
      "analysis.realPhotoNotice": "La foto se analizará en este dispositivo y deberá revisarse antes del cálculo.",
    ...
    fr: {
      ...
      "analysis.realPhotoNotice": "La photo sera analysée sur cet appareil et devra être vérifiée avant le calcul.",
    ...
    de: {
      ...
      "analysis.realPhotoNotice": "Das Foto wird auf diesem Gerät analysiert und muss vor der Berechnung geprüft werden.",
    ...
    it: {
      ...
      "analysis.realPhotoNotice": "La foto verrà analizzata su questo dispositivo e dovrà essere controllata prima del calcolo.",
