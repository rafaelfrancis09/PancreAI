(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      "home.demoPhotos": "Ou escolha uma imagem da galeria do PancreAI",
      "analysis.realPhotoNotice": "A foto será enviada com segurança para análise visual e deve ser revisada antes do cálculo.",
      "analysis.adultConsentTitle": "Confirmação do responsável",
      "analysis.adultConsentMessage": "A análise envia a foto do prato ao Gemini. Confirme que você é um adulto responsável e que revisará os alimentos e as porções antes do cálculo.",
      "analysis.adultConsentConfirm": "Confirmo e continuar",
      "home.howItWorks": "Como funciona",
      "home.howItWorksText": "Tire uma foto ou escolha uma imagem. O Gemini identifica alimentos; você revisa e o app calcula com os dados locais.",
      ...
      "analysis.reanalyze": "Refazer análise",
      "analysis.retakePhoto": "Tirar outra foto",
      "analysis.reviewPhoto": "Revise a foto",
      "analysis.photoQualityUnknown": "Qualidade não informada",
      "analysis.inadequatePhotoHint": "Para melhorar a precisão, tire outra foto. Você também pode refazer a análise com esta imagem.",
      "analysis.reviewPhotoHint": "Confira os alimentos com atenção antes de continuar.",
    ...
    en: {
      ...
      "home.demoPhotos": "Or choose an image from the PancreAI gallery",
      "analysis.realPhotoNotice": "The photo will be sent securely for visual analysis and must be reviewed before calculation.",
      "analysis.adultConsentTitle": "Responsible adult confirmation",
      "analysis.adultConsentMessage": "The analysis sends the plate photo to Gemini. Confirm that you are a responsible adult and will review the foods and portions before calculation.",
      "analysis.adultConsentConfirm": "I confirm and continue",
      "home.howItWorks": "How it works",
      "home.howItWorksText": "Take or choose a photo. Gemini identifies foods; you review them and the app calculates with local data.",
      ...
      "analysis.retakePhoto": "Take another photo",
      "analysis.reviewPhoto": "Review the photo",
      "analysis.photoQualityUnknown": "Photo quality unavailable",
      "analysis.inadequatePhotoHint": "For better accuracy, take another photo. You can also analyze this image again.",
      "analysis.reviewPhotoHint": "Review the foods carefully before continuing.",
      "result.title": "Result",
    ...
    es: {
      ...
      "home.demoPhotos": "O elige una imagen de la galería de PancreAI",
      "analysis.realPhotoNotice": "La foto se enviará de forma segura para el análisis visual y deberá revisarse antes del cálculo.",
      "analysis.adultConsentTitle": "Confirmación del responsable",
      "analysis.adultConsentMessage": "El análisis envía la foto del plato a Gemini. Confirma que eres un adulto responsable y que revisarás los alimentos y las porciones antes del cálculo.",
      "analysis.adultConsentConfirm": "Confirmo y continuar",
      "home.howItWorks": "Como funciona",
      "analysis.confirmTitle": "Confirmar analisis",
      "analysis.reanalyze": "Repetir análisis",
      "analysis.retakePhoto": "Tomar otra foto",
      "analysis.reviewPhoto": "Revisar la foto",
      "analysis.photoQualityUnknown": "Calidad de foto no informada",
      "analysis.inadequatePhotoHint": "Para mejorar la precisión, toma otra foto. También puedes volver a analizar esta imagen.",
      "analysis.reviewPhotoHint": "Revisa los alimentos con atención antes de continuar.",
      "result.title": "Resultado",
    ...
    fr: {
      ...
      "home.demoPhotos": "Ou choisissez une image dans la galerie PancreAI",
      "analysis.realPhotoNotice": "La photo sera envoyée de façon sécurisée pour analyse visuelle et devra être vérifiée avant le calcul.",
      "analysis.adultConsentTitle": "Confirmation du responsable",
      "analysis.adultConsentMessage": "L’analyse envoie la photo du plat à Gemini. Confirmez que vous êtes un adulte responsable et que vous vérifierez les aliments et les portions avant le calcul.",
      "analysis.adultConsentConfirm": "Je confirme et continue",
      "analysis.confirmTitle": "Confirmer l'analyse",
      "analysis.reanalyze": "Relancer l’analyse",
      "analysis.retakePhoto": "Prendre une autre photo",
      "analysis.reviewPhoto": "Vérifiez la photo",
      "analysis.photoQualityUnknown": "Qualité de la photo non indiquée",
      "analysis.inadequatePhotoHint": "Pour améliorer la précision, prenez une autre photo. Vous pouvez aussi analyser cette image à nouveau.",
      "analysis.reviewPhotoHint": "Vérifiez attentivement les aliments avant de continuer.",
    ...
    de: {
      ...
      "home.demoPhotos": "Oder wählen Sie ein Bild aus der PancreAI-Galerie",
      "analysis.realPhotoNotice": "Das Foto wird sicher zur Bildanalyse gesendet und muss vor der Berechnung geprüft werden.",
      "analysis.adultConsentTitle": "Bestätigung durch eine verantwortliche Person",
      "analysis.adultConsentMessage": "Die Analyse sendet das Foto des Tellers an Gemini. Bestätigen Sie, dass Sie eine verantwortliche erwachsene Person sind und Lebensmittel sowie Portionen vor der Berechnung prüfen.",
      "analysis.adultConsentConfirm": "Bestätigen und fortfahren",
      "analysis.confirmTitle": "Analyse bestatigen",
      "analysis.reanalyze": "Analyse wiederholen",
      "analysis.retakePhoto": "Neues Foto aufnehmen",
      "analysis.reviewPhoto": "Foto prüfen",
      "analysis.photoQualityUnknown": "Fotoqualität nicht angegeben",
      "analysis.inadequatePhotoHint": "Für eine höhere Genauigkeit nehmen Sie ein neues Foto auf. Sie können dieses Bild auch erneut analysieren.",
      "analysis.reviewPhotoHint": "Prüfen Sie die Lebensmittel sorgfältig, bevor Sie fortfahren.",
    ...
    it: {
      ...
      "home.demoPhotos": "Oppure scegli una immagine dalla galleria PancreAI",
      "analysis.realPhotoNotice": "La foto verrà inviata in modo sicuro per analisi visiva e dovrà essere controllata prima del calcolo.",
      "analysis.adultConsentTitle": "Conferma del responsabile",
      "analysis.adultConsentMessage": "L’analisi invia la foto del piatto a Gemini. Conferma di essere un adulto responsabile e di verificare alimenti e porzioni prima del calcolo.",
      "analysis.adultConsentConfirm": "Confermo e continuo",
      "analysis.confirmTitle": "Conferma analisi",
      "analysis.reanalyze": "Ripeti analisi",
      "analysis.retakePhoto": "Scatta un'altra foto",
      "analysis.reviewPhoto": "Controlla la foto",
      "analysis.photoQualityUnknown": "Qualità della foto non indicata",
      "analysis.inadequatePhotoHint": "Per migliorare la precisione, scatta un'altra foto. Puoi anche analizzare nuovamente questa immagine.",
      "analysis.reviewPhotoHint": "Controlla attentamente gli alimenti prima di continuare.",
