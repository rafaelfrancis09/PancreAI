(function () {
  ...
  phraseRows.push(
    ...
    ["A foto escolhida é enviada a um serviço externo de IA para análise. Envie somente a refeição e evite rostos, documentos, dados pessoais ou informações de saúde desnecessárias. Dados de tratamento e histórico permanecem no navegador nesta versão.", "The selected photo is sent to an external AI service for analysis. Send only the meal and avoid faces, documents, personal data, or unnecessary health information. Treatment and history data remain in the browser in this version.", "La foto elegida se envía a un servicio externo de IA para su análisis. Envía solo la comida y evita rostros, documentos, datos personales o información de salud innecesaria. Los datos de tratamiento y el historial permanecen en el navegador en esta versión.", "La photo choisie est envoyée à un service d’IA externe pour analyse. Envoyez uniquement le repas et évitez les visages, documents, données personnelles ou informations de santé inutiles. Les données de traitement et l’historique restent dans le navigateur dans cette version.", "Das ausgewählte Foto wird zur Analyse an einen externen KI-Dienst gesendet. Senden Sie nur die Mahlzeit und vermeiden Sie Gesichter, Dokumente, personenbezogene Daten oder unnötige Gesundheitsinformationen. Behandlungs- und Verlaufsdaten bleiben in dieser Version im Browser.", "La foto scelta viene inviata a un servizio di IA esterno per l’analisi. Invia solo il pasto ed evita volti, documenti, dati personali o informazioni sanitarie non necessarie. I dati del trattamento e la cronologia restano nel browser in questa versione."],
    ...
    ["A análise depende da imagem, do serviço externo, das correções do usuário e dos dados cadastrados. O uso deste protótipo é educacional e demonstrativo.", "The analysis depends on the image, the external service, user corrections, and the registered data. This prototype is for educational and demonstration use.", "El análisis depende de la imagen, del servicio externo, de las correcciones del usuario y de los datos registrados. El uso de este prototipo es educativo y demostrativo.", "L’analyse dépend de l’image, du service externe, des corrections de l’utilisateur et des données enregistrées. L’usage de ce prototype est éducatif et démonstratif.", "Die Analyse hängt vom Bild, dem externen Dienst, den Korrekturen des Nutzers und den gespeicherten Daten ab. Dieser Prototyp dient Bildungs- und Demonstrationszwecken.", "L’analisi dipende dall’immagine, dal servizio esterno, dalle correzioni dell’utente e dai dati registrati. L’uso di questo prototipo è educativo e dimostrativo."],
